...
public class FollowUpInputTextCv extends LinearLayout {
    ...
    public FollowUpInputTextCv(Context context, UserInputListener listener) {
        super(context);
        mView = LayoutInflater.from(context).inflate(R.layout.cv_followup_input_text, this);
